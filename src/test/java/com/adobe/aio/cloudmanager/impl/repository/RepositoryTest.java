...
public class RepositoryTest extends AbstractApiTest {
  ...
  void list_success(@Mock EmbeddedProgram mock) throws CloudManagerApiException {
    ...
    Collection<com.adobe.aio.cloudmanager.Repository> repositories = underTest.list(new ProgramImpl(mock, null));
  ...
  void list_limit_success(@Mock EmbeddedProgram mock) throws CloudManagerApiException {
    ...
    Collection<com.adobe.aio.cloudmanager.Repository> repositories = underTest.list(program, 10);
    assertEquals(3, repositories.size());
    client.verify(list);
    client.clear(list);
  }
  ...
  void list_start_limit_success(@Mock EmbeddedProgram mock) throws CloudManagerApiException {
    ...
    Program program = new ProgramImpl(mock, null);
    Collection<com.adobe.aio.cloudmanager.Repository> repositories = underTest.list(program, 10, 10);
    assertEquals(3, repositories.size());
    client.verify(list);
    client.clear(list);
  }
  ...
  void get_success(@Mock EmbeddedProgram mock) throws CloudManagerApiException {
    ...
    Program program = new ProgramImpl(mock, null);
    com.adobe.aio.cloudmanager.Repository repository = underTest.get(program, "1");
  ...
  @Test
  void listBranches_failure_404(@Mock com.adobe.aio.cloudmanager.Repository mock) {
    String sessionId = UUID.randomUUID().toString();
    when(workspace.getApiKey()).thenReturn(sessionId);
  ...
  @Test
  void listBranches_empty(@Mock com.adobe.aio.cloudmanager.Repository mock) throws CloudManagerApiException {
    String sessionId = UUID.randomUUID().toString();
    when(workspace.getApiKey()).thenReturn(sessionId);
    when(mock.getProgramId()).thenReturn("1");
    when(mock.getId()).thenReturn("1");
  ...
  @Test
  void listBranches_success(@Mock com.adobe.aio.cloudmanager.Repository mock) throws CloudManagerApiException {
    String sessionId = UUID.randomUUID().toString();
    when(workspace.getApiKey()).thenReturn(sessionId);
    when(mock.getProgramId()).thenReturn("1");
    when(mock.getId()).thenReturn("1");
  ...
  @Test
  void listBranches_success_viaRepository(@Mock Repository mock) throws CloudManagerApiException {
    String sessionId = UUID.randomUUID().toString();
    when(workspace.getApiKey()).thenReturn(sessionId);
    when(mock.getProgramId()).thenReturn("1");
    when(mock.getId()).thenReturn("1");
    ...
    com.adobe.aio.cloudmanager.Repository repository = new RepositoryImpl(mock, underTest);
